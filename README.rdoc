...
* Supports project specific todo lists. (Creates a file '.todo.yml' in the directory you use it)
* Supports tagging

== Install

==== Original gem from laktek
...
==== This fork
  ...
  gem sources -a http://gems.github.com
  sudo gem install mstuefer-todo
...
Todo is very minimalistic by his nature.
For any issue or improvement, feel free to contact.
